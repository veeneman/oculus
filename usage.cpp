...
void usage(int ret_code)
{
  ...
  fprintf(handle,
	  ...
	  "  --count           : instead of reconstituting SAM output, output single SAM\n"
	  "                      entries with FC:i and RC:i tags with forward and reverse counts\n"
	  "  --trim_left int   : trim int nt from the left edge of reads\n"
	  "  --trim_length int : trim from right edge of reads until they are int length\n\n"
